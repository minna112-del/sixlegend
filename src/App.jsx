...
export default function App() {
  ...
  const renderHome = () => (
    <div className="flex flex-col h-full bg-[#f4f1f8]">
      <div className="bg-[#1e3a8a] text-center py-5 shadow-md z-10"><h1 className="text-yellow-400 text-3xl font-black mb-1 tracking-wider">⭐হিসাবের খাতা⭐</h1><h2 className="text-white text-xl font-bold">Crafted by Mahsin</h2<>/div>
